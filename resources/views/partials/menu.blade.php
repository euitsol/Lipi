            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    <li class="nav-item">
                     ...
                     {{--Manage Deparment--}}
                    <li class="nav-item">
                        <a href="{{ route('departments.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['department.index','department.edit']) ? 'active' : '' }}"><i class="icon-windows2"></i> <span> Department</span></a>
                    </li>

                    {{--Manage Semester--}}
                    <li class="nav-item">
                            {{-- write semester instead  --}}
                        <a href="{{ route('semester.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['semester.index','semester.edit']) ? 'active' : '' }}"><i class="icon-windows2"></i> <span> Semester</span></a>
                    </li>
                    {{--Manage Subjects--}}
                    <li class="nav-item">

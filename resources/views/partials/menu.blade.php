                ...
                @if (Qs::userIsTeamSA())
                    ...
                    <li class="nav-item">
                        <a href="{{ route('userCreation.index') }}"
                            class="nav-link {{ in_array(Route::currentRouteName(), ['userCreation.index', 'userCreation.show', 'userCreation.edit']) ? 'active' : '' }}"><i
                                class="icon-users4"></i> <span> User Creation </span></a>
                    </li>

                    {{-- Manage Deparment --}}
                    <li class="nav-item">
                        <a href="{{ route('departments.index') }}"
                            class="nav-link {{ in_array(Route::currentRouteName(), ['department.index', 'department.edit']) ? 'active' : '' }}"><i

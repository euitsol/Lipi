                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="teacher_id" value="{{ old('teacher_id') }}" type="text"
                                            name="teacher_id" class="form-control" placeholder="Teacher ID" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" name="emp_date" value="{{ old('emp_date') }}"
                                            type="text" required class="form-control date-pick"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" id="gender" name="gender" required
                                            data-fouc data-placeholder="Choose.." required>
                                            <option value=""></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" id="bg_id" name="bg_name" data-fouc
                                            data-placeholder="Choose.." required>
                                            <option value=""></option>
                                            @foreach ($blood_groups as $bg)
                                                <option {{ old('bg_id') == $bg->id ? 'selected' : '' }}
                                                    value="{{ $bg->name }}">{{ $bg->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="d-block">Upload Passport Photo: <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ old('photo') }}" accept="image/*" type="file"
                                            name="photo" class="form-input-styled" required data-fouc>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="d-block">Upload Your CV or Resume: <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ old('resume') }}" accept=".pdf" type="file" name="resume"
                                            ...
                                            <div class="list-icons">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        {{-- View Profile --}}
                                                        <a href="{{ route('teachers.show', Qs::hash($u->id)) }}"
                                                            class="dropdown-item"><i class="icon-eye"></i> View
                                                            Profile</a>
                                                        {{-- Edit --}}
                                                        <a href="{{ route('teachers.edit', Qs::hash($u->id)) }}"
                                                        ...
                                                        @if (Qs::userIsSuperAdmin())
                                                            ...
                                                            <form method="post" id="item-delete-{{ Qs::hash($u->id) }}"
                                                                action="{{ route('teachers.destroy', Qs::hash($u->id)) }}"

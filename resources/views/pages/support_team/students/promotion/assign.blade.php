                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="select form-control" id="deparatment" name="deparatment" data-fouc data-placeholder="Choose.." disabled>
                                <option value="{{Qs::hash($update->departments_id)}}">{{$update->departments->department_name}}</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bg_id">Semester Name: </label>
                            <select class="select form-control" id="semester" name="semester" data-fouc data-placeholder="Choose..">
                                <option value=""></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="bg_id">Group Name: </label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="session_start" value="{{ old('session_start') }}" required type="date" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="session_end">Session End: </label>                               
                            <input name="session_end" value="{{ old('session_end') }}" required type="date" class="form-control">
                        </div>
                    </div>
